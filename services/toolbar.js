...
const buttonConfig = [
	...
	{ id: 'hero-btn-core-follow', label: 'Copiloto/Follow-up', className: 'hero-btn hero-btn-quaternary', handlerKey: 'onCoreFollowUp' },
	{ id: 'hero-btn-pdf', label: '📄 PDF', className: 'hero-btn hero-btn-tertiary', handlerKey: 'onPdf' },
	{ id: 'hero-btn-audio', label: '🎙️ Audio', className: 'hero-btn hero-btn-muted', handlerKey: 'onAudio' },
